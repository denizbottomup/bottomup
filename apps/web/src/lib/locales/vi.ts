...
export const vi: Dict = {
  ...
  lb: {
    ...
    subtitle: '30 ngày gần nhất của mỗi trader trên $10.000 ảo. Nhấn vào thẻ để xem dashboard đầy đủ — đường equity, phân phối R, P&L theo tháng, theo coin.',
    disclaimer: 'Kết quả mô phỏng. Hiệu suất giả định có giới hạn cố hữu. Hiệu suất quá khứ không dự đoán tương lai.',
    cta: 'Xem marketplace →',
    empty: 'Không có lệnh đóng trong 30 ngày qua — quay lại sớm.',
    balance_label: 'Số dư ảo',
    from_label: 'từ $10.000 (30 ngày qua)',
    trades: 'Lệnh',
    wins: 'Thắng',
    win_rate: 'Win rate',
    live: 'Đang chạy',
