...
export const es: Dict = {
  ...
  lb: {
    ...
    subtitle: 'Los últimos 30 días de cada trader sobre $10.000 virtuales. Toca una tarjeta para el dashboard completo — curva de equity, distribución de R, P&L mensual, desglose por moneda.',
    ...
    empty: 'No hay trades cerrados en los últimos 30 días — vuelve pronto.',
    balance_label: 'Balance virtual',
    from_label: 'desde $10.000 (últimos 30 días)',
    trades: 'Trades',
    wins: 'Ganados',
    win_rate: 'Win rate',
    live: 'En vivo',
  ...
  pr: {
    ...
    with_code: 'Desde {price} con código',
    unit_mo: '/ mes',
    unit_3mo: '/ 3 meses',
    unit_6mo: '/ 6 meses',
