...
export const en: Dict = {
  ...
  foxy: {
    ...
    stat: '✓ Foxy AI is in active development — designed to recommend portfolio teams of in-form publishers from across the marketplace.',
  },
  mkt: {
  ...
  whales: {
    label: 'Whale watch',
    headline_1: 'Real money,',
    headline_2: 'moving right now.',
    subtitle:
      "Live feed of every Hyperliquid wallet opening or closing a $1M+ position. Each row is real capital — no demo accounts, no paid leaderboards. The same surface Foxy reads from when it scores your trader's signal.",
    threshold: '$1M+ notional',
    tab_alerts: 'Recent activity',
    tab_positions: 'Top open positions',
    side_long: 'Long',
    side_short: 'Short',
    notional: 'Notional',
    entry: 'Entry',
    ...
    empty: 'No whale activity right now — check back in a minute.',
    source: 'Source: Hyperliquid · CoinGlass · refreshed every minute',
    just_now: 'just now',
  },
  news: {
    label: 'News feed',
