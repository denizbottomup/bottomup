...
export const id: Dict = {
  ...
  lb: {
    ...
    subtitle: '30 hari terakhir tiap trader di $10.000 virtual. Tap kartu untuk dashboard analitik lengkap — kurva equity, distribusi R, P&L bulanan, breakdown per coin.',
    ...
    empty: 'Tidak ada trade ditutup dalam 30 hari terakhir — cek lagi nanti.',
    balance_label: 'Saldo virtual',
    from_label: 'dari $10.000 (30 hari terakhir)',
    trades: 'Trade',
    wins: 'Menang',
    win_rate: 'Win rate',
    live: 'Live',
  ...
  pr: {
    ...
    with_code: 'Mulai {price} dengan kode',
