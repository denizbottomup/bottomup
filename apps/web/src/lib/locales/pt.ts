    ...
    plans: [
      {
        ...
        cta: 'Começar mensal',
        features: [
          'Acesso completo ao marketplace — traders, bots, agentes IA',
          'Firewall Foxy AI em cada sinal',
          'Dashboard de mercado ao vivo (CoinGlass + Binance)',
          'Simulação de portfólio a preços ao vivo',
          'Chat da comunidade · 7 canais',
      ...
      },
      {
        ...
        features: [
          'Tudo do Mensal',
          'Copy trade OKX — execução com um clique',
          'MCP Suite — todos os 9 agentes',
      ...
      },
      {
        ...
        features: [
          'Tudo do trimestral',
          'Recompensas $BUP por volume',
          'Acesso antecipado a TradFi (Q1 2027)',
          'Consultoria de estratégia 1:1',
          'Badge de comunidade founders',
        ],
      },
    ],
    footer:
