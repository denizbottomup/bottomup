...
/**
 * OAuth-only sign up. Open email/password registration was removed so
 * nobody can spin up a throwaway account — new accounts come through
 * Google or Apple only (same flow as sign in).
 */
export default function SignUpPage() {
  ...
  return (
    <AuthCard
      ...
      subtitle="Continue with Google or Apple"
      footer={
        <>
    ...
    >
      ...
      <p className="mt-6 text-xs text-fg-dim text-center">
